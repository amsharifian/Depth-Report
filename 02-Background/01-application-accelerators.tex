...
Processor-level behavioral models such as the Control-Data dependency graph can be used for specifying a single processor, but will not suffice for describing a complete system that consist of many communicating processors.

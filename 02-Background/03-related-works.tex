...
In the rest of the report, we will talk about High-Level Synthesises and different approaches that exist to synthesis from behavioral domain to structural domain.
